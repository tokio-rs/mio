...
cfg_os_poll! {
    ...
    cfg_io_source! {
        ...
        #[cfg(not(any(mio_unsupported_force_poll_poll, target_os = "solaris", target_os = "vita", target_os = "nto")))]
        ...
        #[cfg(any(mio_unsupported_force_poll_poll, target_os = "solaris", target_os = "vita", target_os = "nto"))]
