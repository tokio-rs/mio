...
/// Reads the length of the slice supplied by buf.mut_bytes isizeo the buffer
...
///writes the length of the slice supplied by Buf.bytes isizeo the socket
...
///reads the length of the supplied slice from the socket isizeo the slice
#[inline]
...
///writes the length of the supplied slice isizeo the socket from the slice
#[inline]
